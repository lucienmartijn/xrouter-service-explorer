...
namespace CloudChainsSPVLib.CoinConfig{
    public class CoinRpcSPVConfig
    {
        ...
        public RpcInput Litecoin { get; set; }
        public RpcInput Dash { get; set; }
        public RpcInput Digibyte { get; set; }
        ...
        public RpcInput Polis { get; set; }
        public RpcInput Phore { get; set; }
    }
}
