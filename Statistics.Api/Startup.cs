...
namespace Statistics.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddHttpClient("servicenode", c => 
            //{
            //    c.BaseAddress = new Uri("http://localhost:8080/api/servicenode/");
            //    //c.DefaultRequestHeaders.Add("Content-Type", "application/json");
            //});

            //services.AddHttpClient("xrouter", c =>
            //{
            //    c.BaseAddress = new Uri("http://localhost:8082/api/xr/");
            //    //c.DefaultRequestHeaders.Add("Content-Type", "application/json");
            //});
